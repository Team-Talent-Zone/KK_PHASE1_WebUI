export const ConfigMsg = {
    ...
    covid_alert_en:"We strictly follow the COVID rules & regulations. We encourage our clients & skilled workers to follow the goverment rules. Stay Home, Stay Safe.",
    ...
    payment_sucesss_alert_en: 'Thank you for the payment. Please share your experience by rating our skilled worker.',
    ...
    on_msg: " on ",
    accept_job_msg_1: "You can not accept this job as there are voliation jobs in upcoming list. Please call us as soon as possible. Util this violation issue not resolved you can not accept new jobs. ",
    ...
    accept_job_msg_3: "You can not accept this job until atleast one job is completed among 3 in the upcoming jobs.",
    accept_job_msg_4: "Thank you for accepting your new Job. Now, Go to Upcoming Jobs tab to view more details.",
    ...
    trigger_voliation_msg_1: " is locked to you to complete the voliation process.",
    ...
    confirmation_msg_2: "Do you want to voliation get resolved for the JobId#",
    ...
    resolved_voliation_msg_3: "The voliation is resolved for the Job Id:",
    ...
    bg_sent_manager_msg_1:" Sent BG verification to your manager ",
    bg_completed:" Bg verification is completed ",
