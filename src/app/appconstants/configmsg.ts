export const ConfigMsg = {
    ...
    on_msg: " on ",
    accept_job_msg_1: "You can not accept this job as there are voliation jobs in voliation tab. Please call us as soon as possible. Util this violation issue not resolved you can not accept new jobs. ",
