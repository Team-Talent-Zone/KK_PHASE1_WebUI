...
@Component({
  selector: 'app-homeclienttestimonals',
  templateUrl: './homeclienttestimonals.component.html',
  styleUrls: ['./homeclienttestimonals.component.css']
})
export class HomeclienttestimonalsComponent implements OnInit {
