...
export class FreelanceserviceService {
  ...
  getUserAllJobDetailsByFreelancerId(userId: number) {
    return this.http.get(`${environment.apiUrl}/getUserAllJobDetailsByFreelancerId/` + userId + '/');
  }
  ...
  getUserAllJobDetailsBySubCategory(subcat: string) {
    return this.http.get(`${environment.apiUrl}/getUserAllJobDetailsBySubCategory/`+ subcat + '/');
  }
